...
export default function LoginForm({}: Props) {
  return (
    <form className="space-y-3 w-[360px]">
...
function LoginButton() {
  ...
  return (
    <button className="flex h-16 items-center justify-center rounded-lg bg-blue-500 px-4 font-semibold text-white transition-colors hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 active:bg-blue-600 aria-disabled:cursor-not-allowed aria-disabled:opacity-50 mt-10 w-full">
      Iniciar Sesión
    </button>
  );
}
